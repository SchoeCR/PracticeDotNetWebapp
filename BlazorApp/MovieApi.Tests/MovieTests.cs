...
{
    [Fact]
    public void BuildPrintableMovieTitleWithYearGreaterThanZero()
    {
        // Arrange
        var movie = new Movie
    ...
    public void BuildPrintableMovieTitleWithYearLessThanZero()
    {
        // Arrange
        var movie = new Movie
        { Id = 1, Title = "My Test Movie", PosterUri = "https://imbd.com/graphic/png/10002.png", Year = -5 };

        // Act
        var printableMovieTitle = movie.BuildPrintableMovieTitle();

        // Assert
        Assert.Equal("Title:My Test Movie", printableMovieTitle);
    }
}
